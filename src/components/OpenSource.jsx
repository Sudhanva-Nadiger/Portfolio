...
const Contribution = (props) => {
  return (
    <motion.div
      className="flex filterShadow flex-col justify-between bg-[#11405e] border-[] px-6 py-6 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 transition-colors duration-300 transform border hover:border-transparent dark:border-gray-700 dark:hover:border-transparent"
      whileInView={{ x: [-80, 0], opacity: [0, 1] }}
      transition={{ duration: 1 }}
    >
      <div className="flex flex-row filterShadow">
        <img
          src={props.logo}
        ...
        <div className="flex flex-col ml-4">
          <a
            className="font-poppins font-normal text-[16px] text-white my-1 leading-[24px] hover:text-[#5b86cd]"
            href={props.link}
            target="_blank"
          >
            {props.title}
...
const OpenSource = () => {
  ...
  return (
    <section id="openSrc" className="bg-primaryLinear sm:px-16 px-5 py-4">
      <h1 className="flex-1 font-Poppins font-semibold ss:text-[55px] sm:text-[45px] ss:leading-[80px] leading-[80px]">
      ...
      <div className="container px-2 py-5 mx-auto mb-8">
        ...
        <div className="grid grid-cols-1 justify-center gap-8 mt-8 md:grid-cols-3 sm:grid-cols-2">
