...
export const OPEN_SOURCE_CONTRIBUTIONS: Contribution[] = [
  ...
  },
  {
    ...
    type: "pull-request",
    status: "merged",
    title: "Alternate the color between packaging components",
  ...
  },
  {
    ...
    type: "pull-request",
    status: "merged",
    title: "feat: Add copy to clipBoard button in send email manually",
  ...
  },
  {
    ...
    type: "pull-request",
    status: "merged",
    title: "feat: format sign_up_errors to normal texts instead of HTML",
  ...
  },
  {
    ...
    type: "pull-request",
    status: "merged",
    title: "feat: add rate the app link and share the app link in settings",
  ...
  },
  {
    ...
    type: "pull-request",
    status: "merged",
    title: "Replace usage of LocalizedIcon in 'plain_log_list.tsx'",
  ...
  },
  {
    ...
    type: "pull-request",
    status: "merged",
    title: "Replace usage of LocalizedIcon in 'rhs_header_post.tsx'",
  ...
  {
    id: "os-401",
    organisation: "open-telemetry",
    logo: openTelemetry,
    repo: "opentelemetry.io",
    type: "pull-request",
    status: "merged",
    title: "fix: typo in index.md",
    link: "https://github.com/open-telemetry/opentelemetry.io/pull/9138",
    number: "#9138",
    date: "Feb 10 2025",
    linesAdded: "1",
    linesDeleted: "1",
    technology: SiMarkdown,
  },
];
